...
<v:form id="${vulpeFormName}" name="${vulpeFormName}" theme="simple" validate="true" enctype="multipart/form-data" method="post">
	...
	<c:if test="${securityContext.authenticated && empty popupKey && (empty now['bodyTwice'] || now['bodyTwiceType'] == 'MAIN')}"><%@include file="/WEB-INF/protected-jsp/commons/userAuthenticated.jsp" %></c:if>
