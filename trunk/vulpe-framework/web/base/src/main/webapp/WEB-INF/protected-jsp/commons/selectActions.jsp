...
<v:action labelKey="report" elementId="Report" layer="vulpeSelectTable-${vulpeFormName}" action="${now['controllerConfig'].reportControllerName}/report/ajax" helpKey="report" icon="report" iconClass="Report" config="${util:buttonConfig(pageContext, 'report', 'SELECT')}" />
