...
<v:action validate="false" layer="${popup ? popupKey : layer}" labelKey="clear" elementId="Clear" action="clear" icon="clear" iconClass="Clear" show="${now['buttons']['clear'] || now['buttons']['SELECT_clear']}" />
